...
export default function Page() {
  ...
  // Ingredient names for text-based recipe matching
            ...
            <View style={styles.suggestionsBox}>
              {filteredSuggestions.length > 0 ? (
                filteredSuggestions.map((item, index) => (
                  <TouchableOpacity key={index} style={styles.suggestionItem} onPress={() => addIngredient({ id: Date.now().toString(), name: item, quantity: 1, unit: 'pieces', expiryDate: null, addedDate: new Date().toISOString().split('T')[0] })}>
